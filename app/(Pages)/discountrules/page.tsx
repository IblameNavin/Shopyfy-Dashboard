      ...
      <div className="w-full px-3">
         <div className="py-4 md:py-6 lg:py-8 md:px-[5vw] xl:px-[11vw] flex flex-col gap-4">
            ...
            <div className='flex justify-between items-center'>
               ...
               <button className={`flex items-center justify-between py-2 px-3.5 rounded-md bg-green-500 text-black gap-1 ${isActive ? "text-white" : "text-black"}`}><IoIosAddCircleOutline size={22} /> Add New Rule</button>
            </div>
            ...
            <div className={`py-4 border rounded-md w-full ${isActive ? "bg-white border-black/10 shadow-md text-black" : "bg-[#1C1917] border-white/5 text-white"}`}>
                  ...
                  <div className="w-full overflow-x-auto custom-scrollbar">
                     ...
                     <div className='flex items-center justify-center flex-col px-3 mt-7'>
                        ...
                        <p className={`text-center ${isActive ? "text-gray-500" : "text-gray-600"}`}>You dont have any discount policy yet.</p>
