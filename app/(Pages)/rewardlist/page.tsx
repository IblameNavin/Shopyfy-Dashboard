         ...
         <div className="py-4 md:py-6 lg:py-8 md:px-[5vw] xl:px-[11vw] flex flex-col gap-4">
            ...
            <div className='bg-[#1C1917] py-4 border rounded-md border-white/5 w-full'>
                  ...
                  <div className="w-full overflow-x-auto custom-scrollbar">
                     ...
                     <div className='min-w-[850px] xl:min-w-full flex-1 flex flex-col text-white px-4 pb-1'>
                        ...
                        {clientData?.map((item, index) =>
                                                <div key={item.userId} className={`${tableGridClass} py-6 lg:py-6 px-4 border-b border-white/5 hover:bg-white/3 transition-colors`}>
                                                   <div className='text-center font-medium text-gray-500'>{index + 1}</div>
                                                   <div className='text-center font-medium text-white text-sm'>#{item.userId}</div>
                                                   ...
                                                   <div className='text-center cursor-pointer hover:underline font-medium flex items-center justify-center gap-1'>{item.totalSpend}</div>
                                                </div>
                        )}
